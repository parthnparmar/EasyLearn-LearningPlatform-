...
public static class DbInitializer
{
    public static async Task InitializeAsync(IServiceProvider serviceProvider)
    {
        ...
        // Apply pending migrations (do not use EnsureCreated with migrations)
        ...
        // Create admin user
        var adminEmail = "admineasylearn@gmail.com";
        ...
        if (adminUser == null)
        {
            ...
            var result = await userManager.CreateAsync(adminUser, "parth123");
            if (result.Succeeded)
            {
        ...
        else
        {
            ...
            await userManager.ResetPasswordAsync(adminUser, token, "parth123");
        }
