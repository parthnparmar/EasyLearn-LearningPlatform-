...
public class Exam
{
    ...
    // Exam Structure - Fixed Marking System
    public int PartAMarks { get; set; } = 50; // 25 MCQs × 2 marks = 50 marks
    public int PartBMarks { get; set; } = 30; // Theory - 30 marks
    public int InternalMarks { get; set; } = 20; // Internal Assessment - 20 marks
    public int TotalMarks { get; set; } = 100; // Total: 100 marks
    public int PassingPercentage { get; set; } = 70; // 70% to pass
