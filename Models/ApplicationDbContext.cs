...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    // PYQ System
    public DbSet<PYQ> PYQs { get; set; }
    public DbSet<PYQQuestion> PYQQuestions { get; set; }
    public DbSet<PYQQuestionOption> PYQQuestionOptions { get; set; }
    ...
    // Doubt Chat System
    public DbSet<DoubtChat> DoubtChats { get; set; }
    public DbSet<DoubtMessage> DoubtMessages { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<PYQQuestion>()
            .HasOne(pq => pq.PYQ)
            .WithMany(p => p.Questions)
            .HasForeignKey(pq => pq.PYQId)
            .OnDelete(DeleteBehavior.Cascade);

        builder.Entity<PYQQuestionOption>()
            .HasOne(pqo => pqo.PYQQuestion)
            .WithMany(pq => pq.Options)
            .HasForeignKey(pqo => pqo.PYQQuestionId)
            .OnDelete(DeleteBehavior.Cascade);

        // Configure DoubtChat relationships
        builder.Entity<DoubtChat>()
            .HasOne(dc => dc.Student)
            .WithMany()
        ...
        builder.Entity<DoubtMessage>()
            .HasOne(dm => dm.DoubtChat)
            .WithMany(dc => dc.Messages)
            .HasForeignKey(dm => dm.DoubtChatId)
            .OnDelete(DeleteBehavior.Cascade);
