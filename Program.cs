...
builder.Services.AddScoped<IPYQService, PYQService>();
builder.Services.AddScoped<IDoubtChatService, DoubtChatService>();
builder.Services.AddScoped<IEmailService, EmailService>();
builder.Services.AddHostedService<PYQBackgroundService>();
